...
export default function Home() {
  return (
    <div className="min-h-96 space-y-1 flex flex-col py-5">
      <div className="flex">
        <ProgressBarLink href={'/edit'} className="m-auto">
          <Button className="cursor-pointer"><Plus /> Create A New Resume</Button>
        </ProgressBarLink>
      </div>
